...
```html
<link rel="stylesheet" href="https://github.com/no42-org/lcars-47/releases/download/v0.1.2/lcars.css" />
<script src="https://github.com/no42-org/lcars-47/releases/download/v0.1.2/lcars.iife.js"></script>
```
